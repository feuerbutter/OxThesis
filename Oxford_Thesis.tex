...
\include{text/ch-nu-hist}
\include{text/ch-nu-theo}
% \include{text/ch2-neutrinos}
% \include{text/ch35-nuint}
\include{text/ch3-t2k}
\include{text/ch4-selections}
\include{text/ch5-datamc}
\include{text/ch6-tuning}
\include{text/ch7-hnl}
\include{text/ch8-conclusion}
...
\include{text/appendix-newtech}
\include{text/appendix-perf}
\include{text/appendix-tuning}
\include{text/appendix-hnl}
