  ...
  \end{figure}
   ...
   \end{figure}
    ...
    \section{Development of stopping pion control sample}
          ...
          As shown in Fig.~\ref{fig:sppi-heavylen-pid0}, a cut on the heavy length to keep events below $150~\mm$ can remove a considerable portion of the muon background remaining after the first-pull cut.

          The pull distributions shown are based on the subsample where the pion passes through the Top HAT.
          ...
          The Top HAT subsample has achieved a purity of $96\%$ as shown in Fig.~\ref{fig:sppi-top-ppi} and Fig.~\ref{fig:sspi-top-tpi}, which has $91$ $\pip$ signal events, $3$ $\mu^-$, and $2$ $\mu^+$ background events.
          Similarly, the Bottom HAT subsample has achieved a purity of $87\%$ as shown in Fig.~\ref{fig:sppi-bot-ppi} and Fig.~\ref{fig:sspi-bot-tpi}, which has $293$ $\pip$ signal events, $15$ $\mu^-$, $26$ $\mu^+$, and $1$ $\pim$ background event.
