...
\label{sec:sel-esc}
   ...
   \label{sec:sel-esc-imp}
	...
	More specifically, three samples travel along the $x$-, $y$-, and $z$-axes, and five other samples travel at \blue{$15\deg$, $30$\deg, $45\deg$, $60\deg$, and $75\deg$(need to check why the degree command doesn't work)} to the $x$-axis in the $x$-$z$ plane.
  ...
  \end{figure}
   ...
   \end{figure}
    ...
    \section{Development of stopping pion control sample}
          ...
          Similarly, the Bottom HAT subsample has achieved a purity of $87\%$ as shown in Fig.~\ref{subfig:sppi-bot-ppi} and Fig.~\ref{subfig:pppi-bot-tpi}, which has $293$ $\pip$ signal events, $15$ $\mu^-$, $26$ $\mu^+$, and $1$ $\pim$ background event.
