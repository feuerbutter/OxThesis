  ...
  \end{figure}
   ...
   \end{figure}
       ...
       \label{sec:tl-wp}
        ...
        \label{sec:tl-imp}
          ...
          \begin{figure}
               \centering
               \begin{subfigure}{\dbfigwid\textwidth}
                    \includegraphics[width=\textwidth]{figures/sel/SFGmu_ME_td_hist_al9_fit.png}
                    \caption{SFGD-$\mu$.}
                    \label{subfig:tlpi-me-td-sfgmu}
               \end{subfigure}
               \begin{subfigure}{\dbfigwid\textwidth}
                    \includegraphics[width=\textwidth]{figures/sel/TPCmu_ME_td_hist_al9_fit.png}
                    \caption{TPC-$\mu$.}
    ...
    \section{Development of stopping pion control sample}
          ...
          A good consistentcy check that indeed the pion is selected is to check the time difference between the ME and the end point of the stopping track. 
          This distribution should reproduce the muon exponential decay curve closely.
          The result is shown in Fig.~\ref{fig:sppi-me-td}.
          \begin{figure}
               \centering
               \begin{subfigure}{\dbfigwid\textwidth}
                    \includegraphics[width=\textwidth]{figures/sel/sspi_TOP_ME_td_hist_al6_sfgfinposfit_comb.png}
                    \caption{MC.}
                    \label{subfig:sppi-me-td-mc}
               \end{subfigure}
               \begin{subfigure}{\dbfigwid\textwidth}
                    \includegraphics[width=\textwidth]{figures/sel/sspi_TOP_ME_td_hist_al6_sfgfinpos_fit.png}
                    \caption{Data.}
