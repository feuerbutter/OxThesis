    ...
    \section{Pion Trackless Reconstruction}
       ...
       \subsection{Motivation}
         ...
         The true pion momentum cumulative distribution is shown in Fig.~\ref{subfig:pi-mom-cum}, with the majority of pions having a momentum below $1000~\mevc$.
          ...
          A total of $6$ samples, each with a sufficient (how many) number of events, with pions travlling with a momentum of $200~\mevc$, $300~\mevc$ and $800~\mevc$ and an angle of $0\deg$ and $70\deg$ are simulated.
          ...
          \begin{enumerate}
               \item \textbf{DK@rest(good)}
               \item \textbf{DK@rest(dirty)}
               \item \textbf{DK@flight}
               \item \textbf{Elastic knock-out}
               \item \textbf{Deflection}
               \item \textbf{Absorption}
               \item \textbf{Charge exchange}
               \item \textbf{$\pim$}
               \item \textbf{Escaped}
               \item \textbf{Others}
          \end{enumerate}
          ...
          For unescaped ones are all those that have undergone secondary interactions, so at this high momentum, these pions cannot be reconstructed by the trackless technique.
          \begin{figure}[t]
               \centering
               \begin{subfigure}{\dbfigwid\textwidth}
