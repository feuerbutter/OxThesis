...
Ch.~\ref{ch:hnl} presents a sensitivity study for the upgraded ND using heavy neutral lepton (HNL) simulation package, \code{BeamHNL}, in the \genie~\cite{Andreopoulos:2015wxa} event generator.
