...
\end{align}
where $G_F$ is the Fermi constant, $M$ is the nucleon mass, $m_\pi$ is the pion mass, and the hadronic current is parameterised by the form factors, $F_1$, $F_2$, $F_A$, and $F_P$.
